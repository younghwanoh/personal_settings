...
int main(int argc, char **argv)
{
    ...
    clSetKernelArg(kernel_mt, 4, sizeof(cl_uint)*17*num_work_item, NULL); /* ローカルメモリ(state)*/
    clSetKernelArg(kernel_mt, 5, sizeof(mt_struct)*num_work_item, NULL); /* ローカルメモリ(mts) */
